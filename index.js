...
function addCustomer() {
    ...
    if ((firstName.value != "") && (lastName.value != "") && (Age.value != "")) {
        ...
        if (validateAge(Age.value) == false || validateName(firstName.value) == false || validateName(lastName.value) == false) {
            alert("please enter your name and age correct")
        } else {
...
function showCstomer() {
    ...
    for (let i = 0; i < custmerList.length; i++) {
        cartona += ` <tr><td id="one" class="info"><div>${custmerList[i].fname}</div><input type="text" value="${custmerList[i].fname}" class="test display-none"></td>
<td id="two" class="info"><div>${custmerList[i].lname}</div><input type="text" value="${custmerList[i].lname}" class="test display-none"></td>
<td id="three" class="info"><div>${custmerList[i].age}</div><input type="text" value="${custmerList[i].age}" class="test display-none"></td>
...
<td class="info"><div>${custmerList[i].age}</div><input  type="text" value="${custmerList[i].age}" class="test display-none"></td>
<td class="text-center"><button onclick="editInformation(${i})" id="btn-edit">Edit <i class="fa-solid fa-pen-to-square"></i></button>
<button onclick="saveUpdating(${i})" id="btn-save" class="display-none">Save <i class="fa-solid fa-floppy-disk"></i></button>
<button class="btn-delete" onclick="deleteCustomer(${i})">Delete <i class="fa-solid fa-trash"></i></button></td>
</tr>`
